...
public class ConfTheme implements Tag {

    public static Boolean IMPLEMENT = true;

    public static String ELEMENT_LABEL_FULL = "<conf-theme>";
    public static String ELEMENT_LABEL = "conf-theme";
    ...
    public ConfTheme(Node node, MetaDataBuilder metaDataBuilder) {
        try {
