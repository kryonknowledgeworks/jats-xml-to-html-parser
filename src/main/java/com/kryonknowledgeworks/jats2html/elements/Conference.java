...
public class Conference implements Tag {
    ...
    public static String ELEMENT_LABEL_FULL = "<conference>";
    public static String ELEMENT_LABEL = "conference";
    ...
    public Conference(Node node, MetaDataBuilder metaDataBuilder) {
        try {
