...
public class Table implements Tag {
    ...
    public static String ELEMENT_FULL = "<table>";
    public static String ELEMENT = "table";
    ...
    public Table(Node node, String id, MetaDataBuilder metaDataBuilder) {
        try {
            this.node = node;

            elementFilter();

            this.html += "<table class='table-base' id='"+ id + "'>";
