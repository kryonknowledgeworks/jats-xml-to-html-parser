...
//https://jats.nlm.nih.gov/publishing/tag-library/1.3/element/ack.html
public class Ack implements Tag {

    public static Boolean IMPLEMENT = true;

    public static String ELEMENT_ACK_FULL = "<ack>";
    public static String ELEMENT_ACK = "ack";
    ...
    public Ack(Node node, MetaDataBuilder metaDataBuilder) {
        try {
            this.node = node;
            elementFilter();
