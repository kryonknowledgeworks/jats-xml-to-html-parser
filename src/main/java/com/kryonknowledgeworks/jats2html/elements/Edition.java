...
public class Edition implements Tag {
    ...
    public static String ELEMENT_LABEL_FULL = "<edition>";
    public static String ELEMENT_LABEL = "edition";
    ...
    public Edition(Node node, MetaDataBuilder metaDataBuilder) throws ClassNotFoundException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
        this.node = node;
        elementFilter();
